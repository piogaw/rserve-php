...
class Connection
{
    ...
    public const DT_CHAR = 2;
    public const DT_DOUBLE = 3;
    public const DT_STRING = 4;
    public const DT_BYTESTREAM = 5;
    public const DT_SEXP = 10;
    public const DT_ARRAY = 11;

    public const DEFAULT_HOST = "127.0.0.1";
    public const DEFAULT_PORT = 6311;

    /** this is a flag saying that the contents is large (>0xfffff0) and hence uses 56-bit length field */
    public const DT_LARGE = 64;

    public const CMD_login = 0x001;
    public const CMD_voidEval = 0x002;
    public const CMD_eval = 0x003;
    public const CMD_shutdown = 0x004;
    public const CMD_openFile = 0x010;
    public const CMD_createFile = 0x011;
    public const CMD_closeFile = 0x012;
    public const CMD_readFile = 0x013;
    public const CMD_writeFile = 0x014;
    public const CMD_removeFile = 0x015;
    public const CMD_setSEXP = 0x020;
    public const CMD_assignSEXP = 0x021;

    public const CMD_setBufferSize = 0x081;
    public const CMD_setEncoding = 0x082;

    public const CMD_detachSession = 0x030;
    public const CMD_detachedVoidEval = 0x031;
    public const CMD_attachSession = 0x032;

    // control commands since 0.6-0
    public const CMD_ctrlEval = 0x42;
    public const CMD_ctrlSource = 0x45;
    public const CMD_ctrlShutdown = 0x44;

    public const CMD_Response = 0x10000;

    // errors as returned by Rserve
    public const ERR_auth_failed = 0x41;
    public const ERR_conn_broken = 0x42;
    public const ERR_inv_cmd = 0x43;
    public const ERR_inv_par = 0x44;
    public const ERR_Rerror = 0x45;
    public const ERR_IOerror = 0x46;
    public const ERR_not_open = 0x47;
    public const ERR_access_denied = 0x48;
    public const ERR_unsupported_cmd = 0x49;
    public const ERR_unknown_cmd = 0x4a;
    public const ERR_data_overflow = 0x4b;
    public const ERR_object_too_big = 0x4c;
    public const ERR_out_of_mem = 0x4d;
    public const ERR_ctrl_closed = 0x4e;
    public const ERR_session_busy = 0x50;
    public const ERR_detach_failed = 0x51;

    public static $machine_is_bigendian;
    ...
    public function login($salt = null)
    {
        switch ($this->auth_method) {
            ...
            default:
                throw new Exception(
                    "Could not interpret login method '{$this->auth_method}'"
                );
        }
        $data = _rserve_make_data(
            self::DT_STRING,
            "{$this->username}\n{$this->password}"
        );
    ...
    {
        $this->sendCommand(
            self::CMD_setEncoding,
            _rserve_make_data(self::DT_STRING, $encoding)
        );
    }
